...
export default function Home() {
    ...
    return (
        <>
            <main className={`half-and-half-background min-h-screen flex flex-col items-center py-12 px-6 md:px-12 lg:px-24 overflow-hidden flex-grow`}>
                <ToastContainer />
                ...
                <p className="text-white text-center text-sm mb-2 lg:w-8/12  md:w-3/5 sm:w-1/2">
                ...
                <div className="w-full flex flex-col md:flex-row md:justify-between m-2">
                    <div className="flex flex-col items-center md:items-start mb-4 md:mb-0">
                        <p className="text-sm text-white mb-2 font-semibold">Input language</p>
                        <InputLanguageSelector onLanguageChange={handleInputLanguageChange} />
                    </div>
                    <div className="flex flex-col items-center md:items-start">
                        <p className="text-sm text-white mb-2 font-semibold">Output language</p>
                ...
                <span className="text-sm">View on <a href="https://github.com/iamgreggarcia/funcit/tree/main" target="_blank" className="underline">GitHub</a></span>
